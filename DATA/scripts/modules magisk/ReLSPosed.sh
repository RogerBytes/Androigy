...
REPO="ThePedroo/ReLSPosed"

# Variables pour filtrer le fichier
PREFIX="LSPosed"        # Exemple : le début du nom du fichier
SUFFIX="zygisk-release.zip"        # Exemple : l'extension
...
adb reboot
echo "Redémmarage - Ouvrez LS posed depuis la notification, je conseille les module : heu  heu eheu"
